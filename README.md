...
```
python semantify.py --paper_file ../data/paper_file.pkl --api_key "your api key" --output test_graph.ttl --max 1 --print 1
```
...
```
python validate.py --batch_file ./test_graph.ttl --shacl_file ../validation/shacl-shapes.ttl --validation_output validation_results.ttl --verbose 1
```
## License
